...
This project is indexed by GitNexus as **Shopify-tip** (647 symbols, 1365 relationships, 48 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
